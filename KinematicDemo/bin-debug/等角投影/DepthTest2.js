...
var DepthTest2 = (function (_super) {
    __extends(DepthTest2, _super);
    function DepthTest2() {
        var _this = _super.call(this) || this;
        _this.floor = new egret.Sprite();
        _this.floor.x = 1136 / 2;
        _this.floor.y = 100;
        _this.addChild(_this.floor);
        _this.objectList = [];
        ...
        for (var i = 0; i < c; i++) {
            for (var j = 0; j < c; j++) {
                ...
                _this.floor.addChild(tile);
            }
        }
        _this.floor.touchEnabled = true;
        _this.floor.addEventListener("touchTap", _this.onWorldClick, _this);
        return _this;
    }
    DepthTest2.prototype.onWorldClick = function (event) {
    ...
    DepthTest2.prototype.sortList = function () {
...
__reflect(DepthTest2.prototype, "DepthTest2");
//# sourceMappingURL=DepthTest2.js.map