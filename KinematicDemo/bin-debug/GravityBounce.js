...
var GravityBounce = (function (_super) {
    __extends(GravityBounce, _super);
    function GravityBounce() {
        var _this = _super.call(this) || this;
        _this.numParticles = 30;
        return _this;
    }
    GravityBounce.prototype.init = function () {
        this.particles = [];
    ...
    GravityBounce.prototype.onEnterFrame = function () {
        for (var i = 0; i < this.numParticles; i++) {
    ...
    GravityBounce.prototype.gravitate = function (partA, partB) {
    ...
    GravityBounce.prototype.checkCollision = function (b0, b1) {
        var dx = b1.x - b0.x;
        var dy = b1.y - b0.y;
    ...
    GravityBounce.prototype.rotate = function (x, y, sin, cos, reverse) {
...
__reflect(GravityBounce.prototype, "GravityBounce");
